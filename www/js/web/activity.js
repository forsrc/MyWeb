$(document).ready(function() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://crm.primehomes.com/index.php?entryPoint=crmAppJson&session_id=' +
            sessionStorage.sessionId + '&user_name=' +
        ...
        success: function(response) {
            ...
            $(".loader").fadeOut("slow", function() {
                ...
                $(
                    "#activityContent #newLeads table tbody"
                ).append(
                    nodeA);
                $(
                    "#activityContent #followUpLeads table tbody"
                ).append(
                    nodeB);
    ...
    $(document).on('click', '#activityContent table tr td.leadnoClick',
        function() {
            ...
            if (id != null) {
                ...
                var activeTab = $(this).closest('.tab-pane').attr(
                    "id");
