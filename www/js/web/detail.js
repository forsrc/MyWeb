            ...
            success: function(response) {
                ...
                $(".loader").fadeOut("slow", function() {
                    ...
                    $.each(response.activity_log, function(key, value) {
                        ...
                        node = '<div class="list-group-item">\
                                    <div class="row-action-primary">\
                                        <i class="material-icons">track_changes</i>\
                                    </div>\
                                    <div class="row-content">\
                                        <h4 class="list-group-item-heading">'+ value.date_enter +'</h4>\
                                            <p class="list-group-item-text excerpt">'+ excerpt +'<strong>&nbsp;&nbsp;[...]</strong></p>\
                                            <p class="list-group-item-text full-text hidden">'+ value.description +'</p>\
                                    </div>\
